...
public class Plugin : BasePlugin
{
    ...
    public static ConfigEntry<bool> BooleanMoveFollowHead, BooleanViewRemoveRotationLimit, BooleanViewField,
        BooleanTestGiraffe, BooleanCustomShowSelfInfo, BooleanGameAutoReady, BooleanGameNoCooldown;
    ...
    private void PatchAll()
    {
        ...
        Harmony.CreateAndPatchAll(typeof(NoCooldownPatch), nameof(NoCooldownPatch));
    ...
    private void BindConfigPosition()
    {
        ...
        {
            KeyPosition[i] = Config.Bind("Position", $"Position{i + 1}", new KeyboardShortcut(KeyCode.None), $"移动到坐标{i + 1}");
